...
def select2DropdownInput = { String labelName, String textToSearch, String fallbackXpath = '' ->
    ...
    strictSearchField.addProperty('xpath', com.kms.katalon.core.testobject.ConditionType.EQUALS, '//span[contains(@class, \'select2-container--open\')]//input[@type=\'search\' or @class=\'select2-search__field\']', 
        true)
...
// =========================================================================
def c = { String name ->
    findTestObject("Page_Create Customer - PT Dummy Rimba Yogyakarta/$name")
}
